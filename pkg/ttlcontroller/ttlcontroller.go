...
func (c *Controller) runWorker() {
	...
	c.event.DeleteByFinishTime(context.Background(), c.ttlconfig.EventTTL)                  // nolint
	c.experiment.DeleteByFinishTime(context.Background(), c.ttlconfig.ArchiveExperimentTTL) // nolint
}
