...
func (it *TemplateCollector) Setup(mgr ctrl.Manager, apiType client.Object) error {
	it.apiType = apiType
...
func (it *TemplateCollector) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	if it.apiType == nil {
...
func (it *TemplateCollector) persistentWorkflow(workflow *v1alpha1.Workflow) error {
