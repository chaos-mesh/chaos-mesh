    ...
    "definitions": {
        ...
        "v1alpha1.DiskChaosSpec": {
            ...
            "properties": {
                ...
                "fill_by_fallocate": {
                    "description": "Fill disk by fallocate instead of dd\n+kubebuilder:default=true",
                    "type": "boolean"
                },
                "loop_execution": {
                ...
                "path": {
                    "description": "'path' specifies the location to fill data in.\nIf path not provided, a temp file will be generated and deleted immediately after data filled in or allocated.\n+optional",
                    "type": "string"
                },
                "percent": {
                    "description": "'percent' how many percent data of disk will fill in the file path.",
                    "type": "string"
                },
                "process_num": {
                    "description": "'process-num' specifies the number of process work on reading, only 1-255 is valid value.",
                    "type": "integer"
                },
                "remoteCluster": {
                    "description": "RemoteCluster represents the remote cluster where the chaos will be deployed\n+optional",
