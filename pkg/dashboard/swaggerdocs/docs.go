    ...
    "definitions": {
        ...
        "v1alpha1.CloudStackAPIConfig": {
            ...
            "properties": {
                ...
                "apiKeyField": {
                    "description": "APIKeyField defines the key under which the value for API key is stored inside the secret.\n+optional",
                    "type": "string",
                    "default": "api-key"
                },
                "apiSecretField": {
                    "description": "APISecretField defines the key under which the value for API secret is stored inside the secret.\n+optional",
                    "type": "string",
                    "default": "api-secret"
                },
                "secretName": {
                    "description": "SecretName defines the name of the secret where the API credentials are stored.",
                    "type": "string"
                },
                "verifySSL": {
        ...
        "v1alpha1.CloudStackVMChaosSelector": {
            "type": "object",
            "properties": {
                "account": {
                    "description": "Account defines account to list resources by. Must be used with the domainId parameter.\n+optional",
                    "type": "string"
                },
                "affinityGroupId": {
                    "description": "AffinityGroupID defines affinity group to list the VMs by.\n+optional",
                    "type": "string"
                },
                "displayVm": {
                    "description": "DisplayVM defines a flag that indicates whether to list VMs by the display flag.\n+optional",
                    "type": "boolean"
                },
                "domainId": {
                ...
                "groupId": {
                    "description": "GroupID defines the ID of the group the VMs belong to.\n+optional",
                    "type": "string"
                },
                "hostId": {
                    "description": "HostID defines the ID of the host the VMs belong to.\n+optional",
                    "type": "string"
                },
                "hypervisor": {
                ...
                "ids": {
                    "description": "IDs defines a list of VM IDs, mutually exclusive with ID.\n+optional",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "isRecursive": {
                    "description": "IsRecursive defines whether VMs should be listed recursively from parent specified by DomainID.\n+optional",
                    "type": "boolean"
                },
                "isoid": {
                ...
                "keyPair": {
                    "description": "KeyPair defines the SSH keypair name to list the VMs by.\n+optional",
                    "type": "string"
                },
                "keyword": {
                ...
                "listAll": {
                    "description": "ListAll defines whether to list just the resources that belong to the caller or all the resources the caller is\nauthorised to see.\n+optional",
                    "type": "boolean"
                },
                "name": {
                ...
                "networkId": {
                    "description": "NetworkID defines the ID of the network to list the VMs by.\n+optional",
                    "type": "string"
                },
                "projectId": {
                    "description": "ProjectID defines the project ID to list the VMs by.\n+optional",
                    "type": "string"
                },
                "serviceOffering": {
                    "description": "ServiceOffering defines the service offering to list the VMs by.\n+optional",
                    "type": "string"
                },
                "state": {
                ...
                "storageId": {
                    "description": "StorageID defines the ID the storage where VM's volumes belong to.\n+optional",
                    "type": "string"
                },
                "tags": {
                    "description": "Tags defines key/value pairs that should match the tags of the VMs.\n+optional",
                    "type": "object",
                    "additionalProperties": {
                        "type": "string"
                    }
                ...
                "templateId": {
                    "description": "TemplateID defines the ID of the template that was used to create the VMs.\n+optional",
                    "type": "string"
                },
                "userId": {
                    "description": "UserID defines the user ID that created the VM and is under the account that owns the VM.\n+optional",
                    "type": "string"
                },
                "vpcId": {
                ...
                "zoneId": {
                    "description": "ZoneID defines the availability zone the VM belongs to.\n+optional",
                    "type": "string"
                }
            }
        },
        "v1alpha1.CloudStackVMChaosSpec": {
            "type": "object",
            "properties": {
                "action": {
                ...
                "selector": {
                    ...
                    "$ref": "#/definitions/v1alpha1.CloudStackVMChaosSelector"
                }
            }
        },
