...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "github_com_chaos-mesh_chaos-mesh_api_v1alpha1.ChaosCondition": {
            "type": "object",
            "properties": {
                "reason": {
                    "description": "+optional",
                ...
                "type": {
                    "$ref": "#/definitions/github_com_chaos-mesh_chaos-mesh_api_v1alpha1.ChaosConditionType"
                }
            }
        },
        "github_com_chaos-mesh_chaos-mesh_api_v1alpha1.ChaosConditionType": {
            "type": "string",
            "enum": [
                "Selected",
                "AllInjected",
            ...
            "x-enum-varnames": [
                "ConditionSelected",
                "ConditionAllInjected",
                "ConditionAllRecovered",
                "ConditionPaused"
            ]
        },
        ...
        "github_com_chaos-mesh_chaos-mesh_api_v1alpha1.ChaosStatus": {
            "type": "object",
            "properties": {
                "conditions": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_chaos-mesh_chaos-mesh_api_v1alpha1.ChaosCondition"
                    }
                },
                "experiment": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_chaos-mesh_chaos-mesh_api_v1alpha1.ExperimentStatus"
                        }
                    ]
                }
            }
        ...
        "github_com_chaos-mesh_chaos-mesh_api_v1alpha1.DesiredPhase": {
            "type": "string",
            "enum": [
                "Run",
                "Stop"
        ...
        "github_com_chaos-mesh_chaos-mesh_api_v1alpha1.ExperimentStatus": {
            "type": "object",
            "properties": {
                "containerRecords": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_chaos-mesh_chaos-mesh_api_v1alpha1.Record"
                    }
                },
                "desiredPhase": {
                    "description": "+kubebuilder:validation:Enum=Run;Stop",
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_chaos-mesh_chaos-mesh_api_v1alpha1.DesiredPhase"
                        }
                    ]
                }
            }
        ...
        "github_com_chaos-mesh_chaos-mesh_api_v1alpha1.Phase": {
            "type": "string",
            "enum": [
                "Not Injected",
                "Injected"
        ...
        "github_com_chaos-mesh_chaos-mesh_api_v1alpha1.Record": {
            "type": "object",
            "properties": {
                "events": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_chaos-mesh_chaos-mesh_api_v1alpha1.RecordEvent"
                    }
                },
                "id": {
                    "type": "string"
                ...
                "phase": {
                    "$ref": "#/definitions/github_com_chaos-mesh_chaos-mesh_api_v1alpha1.Phase"
                },
                "recoveredCount": {
        ...
        "github_com_chaos-mesh_chaos-mesh_api_v1alpha1.RecordEvent": {
            "type": "object",
            "properties": {
                "message": {
                ...
                "operation": {
                    "description": "Operation represents the operation we are doing when we create this event",
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_chaos-mesh_chaos-mesh_api_v1alpha1.RecordEventOperation"
                        }
                    ]
                },
                "timestamp": {
                ...
                "type": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_chaos-mesh_chaos-mesh_api_v1alpha1.RecordEventType"
                        }
                    ]
                }
            }
        },
        "github_com_chaos-mesh_chaos-mesh_api_v1alpha1.RecordEventOperation": {
            "type": "string",
            "enum": [
                "Apply",
                "Recover"
        ...
        "github_com_chaos-mesh_chaos-mesh_api_v1alpha1.RecordEventType": {
            "type": "string",
            "enum": [
                "Succeeded",
                "Failed"
        ...
        "github_com_chaos-mesh_chaos-mesh_pkg_dashboard_apiserver_types.ArchiveDetail": {
            ...
            "properties": {
                "chaos_status": {
                    "$ref": "#/definitions/github_com_chaos-mesh_chaos-mesh_api_v1alpha1.ChaosStatus"
                },
                "created_at": {
                    "type": "string"
                },
