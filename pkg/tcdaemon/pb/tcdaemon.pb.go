...
func init() {
	proto.RegisterType((*NetemRequest)(nil), "tcdaemon.NetemRequest")
	proto.RegisterType((*Netem)(nil), "tcdaemon.Netem")
}

func init() { proto.RegisterFile("tcdaemon.proto", fileDescriptor_d4925ade7a16fc3f) }
...
// TcDaemonClient is the client API for TcDaemon service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type TcDaemonClient interface {
...
type tcDaemonClient struct {
	cc *grpc.ClientConn
}

func NewTcDaemonClient(cc *grpc.ClientConn) TcDaemonClient {
	return &tcDaemonClient{cc}
}

func (c *tcDaemonClient) SetNetem(ctx context.Context, in *NetemRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/tcdaemon.TcDaemon/SetNetem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tcDaemonClient) DeleteNetem(ctx context.Context, in *NetemRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/tcdaemon.TcDaemon/DeleteNetem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// TcDaemonServer is the server API for TcDaemon service.
type TcDaemonServer interface {
	SetNetem(context.Context, *NetemRequest) (*empty.Empty, error)
	DeleteNetem(context.Context, *NetemRequest) (*empty.Empty, error)
}

// UnimplementedTcDaemonServer can be embedded to have forward compatible implementations.
type UnimplementedTcDaemonServer struct {
}

func (*UnimplementedTcDaemonServer) SetNetem(ctx context.Context, req *NetemRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetNetem not implemented")
}
func (*UnimplementedTcDaemonServer) DeleteNetem(ctx context.Context, req *NetemRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteNetem not implemented")
}

func RegisterTcDaemonServer(s *grpc.Server, srv TcDaemonServer) {
	s.RegisterService(&_TcDaemon_serviceDesc, srv)
}

func _TcDaemon_SetNetem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NetemRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TcDaemonServer).SetNetem(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tcdaemon.TcDaemon/SetNetem",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TcDaemonServer).SetNetem(ctx, req.(*NetemRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TcDaemon_DeleteNetem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NetemRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TcDaemonServer).DeleteNetem(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tcdaemon.TcDaemon/DeleteNetem",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TcDaemonServer).DeleteNetem(ctx, req.(*NetemRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _TcDaemon_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tcdaemon.TcDaemon",
	HandlerType: (*TcDaemonServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SetNetem",
			Handler:    _TcDaemon_SetNetem_Handler,
		},
		{
			MethodName: "DeleteNetem",
			Handler:    _TcDaemon_DeleteNetem_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "tcdaemon.proto",
}
