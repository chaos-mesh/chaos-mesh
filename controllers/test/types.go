...
func (c *MockChaosDaemonClient) FlushIptablesChains(ctx context.Context, in *chaosdaemon.IptablesChainsRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	return nil, mockError("FlushIptablesChains")
}
