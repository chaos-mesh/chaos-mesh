...
func (impl *Impl) Apply(ctx context.Context, index int, records []*v1alpha1.Record, obj v1alpha1.InnerObject) (v1alpha1.Phase, error) {
	...
	if err != nil {
		impl.Log.Error(err, "Failed to decode container record")
	...
	if err != nil {
		impl.Log.Error(err, "Failed to prepare bpfki client")
		return v1alpha1.NotInjected, err
	}
	defer conn.Close()

	kernelChaos := obj.(*v1alpha1.KernelChaos)
	callchain := impl.generateFailKernRequestFrame(kernelChaos.Spec.FailKernRequest.Callchain)
	...
	if err != nil {
		impl.Log.Error(err, "Fail mm or bio error")
		return v1alpha1.NotInjected, err
	}
...
func (impl *Impl) Recover(ctx context.Context, index int, records []*v1alpha1.Record, obj v1alpha1.InnerObject) (v1alpha1.Phase, error) {
	...
	if err != nil {
		impl.Log.Error(err, "Recover mm or bio error")
		return v1alpha1.Injected, err
	}
...
func (impl *Impl) generateFailKernRequestFrame(callChain []v1alpha1.Frame) (requestFrame []*pb_kernel.FailKernRequestFrame) {
