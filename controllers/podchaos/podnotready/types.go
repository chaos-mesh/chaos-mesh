...
func (r *endpoint) setAllPodsNotReady(ctx context.Context, pods []v1.Pod, podchaos *v1alpha1.PodChaos) error {
...
func (r *endpoint) setPodReadyAndRecover(ctx context.Context, podchaos *v1alpha1.PodChaos) error {
	var result error
...
func init() {
	router.Register("podchaos", &v1alpha1.PodChaos{}, func(obj runtime.Object) bool {
		...
		return chaos.Spec.Action == v1alpha1.PodNotReadyAction
