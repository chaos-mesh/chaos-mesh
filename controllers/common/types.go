...
const (
	...
	// the chaos implementation should record injected targets inside the status
	// to make sure they could be updated even after this resource has been deleted.
	PreFinalizer = `chaos-mesh/pre-finalizer`
)
