...
// CommonReconciler is reconciler for partition
...
// Apply would perform common chaos for networkchaos partition
...
// Recover would recover the common chaos for networkchaos partition
