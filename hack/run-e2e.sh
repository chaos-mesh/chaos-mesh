...
function e2e::image_load() {
    ...
    if [ "$PROVIDER" == "kind" ]; then
        ...
        # ghcr.io/chaos-mesh/chaos-coredns:latest, nginx:latest and gcr.io/google-containers/pause:latest is required for test
        # we suppose that you could pull this image on your host docker
        echo "info: load images ghcr.io/chaos-mesh/chaos-coredns:latest, nginx:latest and gcr.io/google-containers/pause:latest"
