...
- PodChaos container-kill now supports targeting init containers when container names are explicitly specified [#4810](https://github.com/chaos-mesh/chaos-mesh/pull/4810)
