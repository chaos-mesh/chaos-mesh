...
- Fix KernelChaos never injecting (controller looping on "too few parts of namespacedname") by selecting targets with ContainerSelector and resolving the runtime container id via the record decoder, matching the other container-scoped chaos types [#5030](https://github.com/chaos-mesh/chaos-mesh/pull/5030)
