...
func init() {
	...
	flag.StringVar(&conf.TLSConfig.CaCert, "ca", "", "ca certificate of grpc server")
	flag.StringVar(&conf.TLSConfig.Cert, "cert", "", "certificate of grpc server")
	flag.StringVar(&conf.TLSConfig.Key, "key", "", "key of grpc server")
