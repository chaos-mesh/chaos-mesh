...
OPTIONS:
    ...
    -c  --crd                The URL of the crd files, default value: https://mirrors.chaos-mesh.org/v0.9.1/crd.yaml
    ...
    -f  --chaosfs-sidecar    The URL of the chaosfs sidecar configmap files, default value: https://mirrors.chaos-mesh.org/v0.9.1/chaosfs-sidecar.yaml
...
main() {
    ...
    local crd="https://mirrors.chaos-mesh.org/v0.9.1/crd.yaml"
    local chaosfs="https://mirrors.chaos-mesh.org/v0.9.1/chaosfs-sidecar.yaml"
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: chaos-daemon
          image: pingcap/chaos-daemon:v0.9.1
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: chaos-dashboard
          image: pingcap/chaos-dashboard:v0.9.1
          imagePullPolicy: IfNotPresent
          resources:
            limits: {}
            requests:
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
      - name: chaos-mesh
        image: pingcap/chaos-mesh:v0.9.1
        imagePullPolicy: IfNotPresent
        resources:
            limits: {}
            requests:
