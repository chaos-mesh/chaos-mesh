...
* **errno**: defines the error code that is returned by an IO action. It and [errno](http://man7.org/linux/man-pages/man3/errno.3.html) defined by linux are consistent. It is an int32 string like `"2"`, `"2"` means `No such file or directory`. 
