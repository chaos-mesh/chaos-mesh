...
func (in *StressChaosStatus) DeepCopyInto(out *StressChaosStatus) {
	*out = *in
	...
	if in.Instances != nil {
		...
		*out = make(map[string]StressInstances, len(*in))
		for key, val := range *in {
			var outVal []StressInstance
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = make(StressInstances, len(*in))
				for i := range *in {
					(*in)[i].DeepCopyInto(&(*out)[i])
				}
			}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in StressInstances) DeepCopyInto(out *StressInstances) {
	{
		in := &in
		*out = make(StressInstances, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StressInstances.
func (in StressInstances) DeepCopy() StressInstances {
	if in == nil {
		return nil
	}
	out := new(StressInstances)
	in.DeepCopyInto(out)
	return *out
}
