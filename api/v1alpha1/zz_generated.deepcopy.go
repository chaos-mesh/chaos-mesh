...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProtectorSpec) DeepCopyInto(out *ProtectorSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProtectorSpec.
func (in *ProtectorSpec) DeepCopy() *ProtectorSpec {
	if in == nil {
		return nil
	}
	out := new(ProtectorSpec)
	in.DeepCopyInto(out)
	return out
}
