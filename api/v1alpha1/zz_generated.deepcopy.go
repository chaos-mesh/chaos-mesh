...
func (in *PodHttpChaosReplaceActions) DeepCopyInto(out *PodHttpChaosReplaceActions) {
	*out = *in
	...
	if in.Body != nil {
		in, out := &in.Body, &out.Body
		*out = make(PodHttpChaosReplaceBodyAction, len(*in))
		copy(*out, *in)
	}
	if in.Queries != nil {
		in, out := &in.Queries, &out.Queries
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in PodHttpChaosReplaceBodyAction) DeepCopyInto(out *PodHttpChaosReplaceBodyAction) {
	{
		in := &in
		*out = make(PodHttpChaosReplaceBodyAction, len(*in))
		copy(*out, *in)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodHttpChaosReplaceBodyAction.
func (in PodHttpChaosReplaceBodyAction) DeepCopy() PodHttpChaosReplaceBodyAction {
	if in == nil {
		return nil
	}
	out := new(PodHttpChaosReplaceBodyAction)
	in.DeepCopyInto(out)
	return *out
}
