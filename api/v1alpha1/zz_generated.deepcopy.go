...
func (in *BlockChaosSpec) DeepCopyInto(out *BlockChaosSpec) {
	*out = *in
	in.NodeVolumePathSelector.DeepCopyInto(&out.NodeVolumePathSelector)
	if in.Duration != nil {
		in, out := &in.Duration, &out.Duration
		*out = new(string)
		**out = **in
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeVolumePathSelector) DeepCopyInto(out *NodeVolumePathSelector) {
	*out = *in
	in.PodSelector.DeepCopyInto(&out.PodSelector)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeVolumePathSelector.
func (in *NodeVolumePathSelector) DeepCopy() *NodeVolumePathSelector {
	if in == nil {
		return nil
	}
	out := new(NodeVolumePathSelector)
	in.DeepCopyInto(out)
	return out
}
