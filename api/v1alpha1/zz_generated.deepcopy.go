...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CommonSelectorSpec) DeepCopyInto(out *CommonSelectorSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommonSelectorSpec.
func (in *CommonSelectorSpec) DeepCopy() *CommonSelectorSpec {
	if in == nil {
		return nil
	}
	out := new(CommonSelectorSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EmbedChaos) DeepCopyInto(out *EmbedChaos) {
	*out = *in
	...
	if in.PhysicalMachine != nil {
		in, out := &in.PhysicalMachine, &out.PhysicalMachine
...
func (in *PhysicalMachineSelectorSpec) DeepCopyInto(out *PhysicalMachineSelectorSpec) {
	*out = *in
	in.CommonSelectorSpec.DeepCopyInto(&out.CommonSelectorSpec)
