...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AWSFilter) DeepCopyInto(out *AWSFilter) {
	*out = *in
	if in.Values != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSFilter.
func (in *AWSFilter) DeepCopy() *AWSFilter {
	if in == nil {
		return nil
	}
	out := new(AWSFilter)
