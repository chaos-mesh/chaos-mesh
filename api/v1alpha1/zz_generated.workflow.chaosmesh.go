...
const (
	...
	TypeEnvoyGatewayChaos TemplateType = "EnvoyGatewayChaos"
...
type EmbedChaos struct {
	...
	// +optional
	EnvoyGatewayChaos *EnvoyGatewayChaosSpec `json:"envoygatewayChaos,omitempty"`
	// +optional
...
func (it *EmbedChaos) SpawnNewObject(templateType TemplateType) (GenericChaos, error) {
	...
	case TypeDNSChaos:
		...
		return &result, nil
	case TypeEnvoyGatewayChaos:
		result := EnvoyGatewayChaos{}
		result.Spec = *it.EnvoyGatewayChaos
		return &result, nil
	case TypeGCPChaos:
		result := GCPChaos{}
...
func (it *EmbedChaos) RestoreChaosSpec(root interface{}) error {
	...
	case *EnvoyGatewayChaos:
		*it.EnvoyGatewayChaos = chaos.Spec
		return nil
	case *GCPChaos:
...
func (in *EnvoyGatewayChaosList) GetItems() []GenericChaos {
	var result []GenericChaos
	for _, item := range in.Items {
		item := item
		result = append(result, &item)
