...
type StressInstance struct {
	// StressUid represents a unique running stress-ng process
	// +optional
	StressUid string `json:"stressUid"`

	// MemUid represents a unique running memStress process
	// +optional
	MemUid string `json:"memUid"`
