...
* **selector** is used to select pods that are used to inject chaos actions. For more details, see [Define the Scope of Chaos Experiment](../user_guides/experiment_scope.md).
