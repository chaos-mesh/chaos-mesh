      ...
      children: [
        {
          ...
          value: '',
          helperText:
            'Optional. Filling determines what is filled in the miskate data.  +kubebuilder:validation:Enum=zero;random',
        },
        {
          field: 'text',
          label: 'maxLength',
          value: 0,
          helperText: 'Optional. Max length of each wrong data segment in bytes  +kubebuilder:validation:Minimum=1',
        },
        {
          field: 'text',
          ...
          value: 0,
          helperText:
            'Optional. There will be [1, MaxOccurrences] segments of wrong data.  +kubebuilder:validation:Minimum=1',
        },
      ],
    },
    {
