            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/archive.StatusResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/experiment.StatusResponse"
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/core.ExperimentInfo"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/core.ScheduleInfo"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/schedule.StatusResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "core.ExperimentInfo": {
            ...
            "properties": {
                ...
                "scheduler": {
                    "type": "object",
                    "$ref": "#/definitions/core.SchedulerInfo"
                },
                "scope": {
                    "type": "object",
                    "$ref": "#/definitions/core.ScopeInfo"
                },
                "target": {
                    "type": "object",
                    "$ref": "#/definitions/core.TargetInfo"
                }
            }
        },
        "core.GCPChaosInfo": {
        ...
        "core.TargetInfo": {
            ...
            "properties": {
                "aws_chaos": {
                    "type": "object",
                    "$ref": "#/definitions/core.AWSChaosInfo"
                },
                "dns_chaos": {
                    "type": "object",
                    "$ref": "#/definitions/core.DNSChaosInfo"
                },
                "gcp_chaos": {
                    "type": "object",
                    "$ref": "#/definitions/core.GCPChaosInfo"
                },
                "io_chaos": {
                    "type": "object",
                    "$ref": "#/definitions/core.IOChaosInfo"
                },
                "kernel_chaos": {
                    "type": "object",
                    "$ref": "#/definitions/core.KernelChaosInfo"
                },
                "kind": {
                    "type": "string"
                },
                "network_chaos": {
                    "type": "object",
                    "$ref": "#/definitions/core.NetworkChaosInfo"
                },
                "pod_chaos": {
                    "type": "object",
                    "$ref": "#/definitions/core.PodChaosInfo"
                },
                "stress_chaos": {
                    "type": "object",
                    "$ref": "#/definitions/core.StressChaosInfo"
                },
                "time_chaos": {
                    "type": "object",
                    "$ref": "#/definitions/core.TimeChaosInfo"
                }
            }
        },
        "core.TimeChaosInfo": {
